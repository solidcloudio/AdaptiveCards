...
public class ParseContext {
  ...
  public void setElementIds(SWIGTYPE_p_std__unordered_setT_std__string_t value) {
    AdaptiveCardObjectModelJNI.ParseContext_elementIds_set(swigCPtr, this, SWIGTYPE_p_std__unordered_setT_std__string_t.getCPtr(value));
  }

  public SWIGTYPE_p_std__unordered_setT_std__string_t getElementIds() {
    long cPtr = AdaptiveCardObjectModelJNI.ParseContext_elementIds_get(swigCPtr, this);
    return (cPtr == 0) ? null : new SWIGTYPE_p_std__unordered_setT_std__string_t(cPtr, false);
  }
